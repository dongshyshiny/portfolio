...
/* Project Modal */
const ProjectModal: React.FC<{ project: (Project & { _title?: string; _description?: string; _role?: string; _features?: string[]; _highlights?: string[] }) | null; onClose: () => void; labels: { keyFeatures: string; highlightsLabel: string; technologies: string; visitWebsite: string } }> = ({ project, onClose, labels }) => {
  useEffect(() => {
...
const PortfolioInner: React.FC = () => {
  ...
  const [selectedProject, setSelectedProject] = useState<(Project & { _title?: string; _description?: string; _role?: string; _features?: string[]; _highlights?: string[] }) | null>(null);
...
{'}'};
      ...
      <ProjectModal
        ...
        labels={{ keyFeatures: t.projects.keyFeatures, highlightsLabel: t.projects.highlightsLabel, technologies: t.projects.technologies, visitWebsite: t.projects.visitWebsite }}
      />
