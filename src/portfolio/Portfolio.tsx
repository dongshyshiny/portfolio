...
const Portfolio: React.FC = () => {
  ...
  const projects = [
    { title: 'Enterprise CRM Platform', description: 'A comprehensive CRM system with real-time communication, task management, and analytics dashboard.', techs: ['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Docker'], gradient: 'linear-gradient(135deg, #7c3aed, #2563eb)' },
    { title: 'Mobile Banking App', description: 'Cross-platform mobile banking application with biometric authentication, QR payment, and transaction management.', techs: ['React Native', 'Java', 'Spring Boot', 'Redis'], gradient: 'linear-gradient(135deg, #06b6d4, #8b5cf6)' },
