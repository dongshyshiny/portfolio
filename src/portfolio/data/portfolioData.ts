...
export const projects: Project[] = [
  ...
  {
    title: 'Alohub CMS',
    description: 'Hệ thống quản trị nội dung cho nền tảng Alohub — quản lý người dùng, cấu hình tổng đài, phân quyền, quản lý chiến dịch và kịch bản cuộc gọi.',
    ...
    period: 'Nov 2022 — Present',
    features: [
      'Quản lý tenant & người dùng',
      'Cấu hình IVR & kịch bản cuộc gọi',
      'Quản lý chiến dịch autocall/autodialer',
      'Phân quyền RBAC chi tiết',
      'Báo cáo & export dữ liệu',
      'Quản lý SIP trunk & số điện thoại',
    ],
  },
  // === InfoPlus ===
  {
